...
function logInfo(language, language2) {
  console.log(`Я учусь программировать на ${language} и ${language2}`);
}

const person = { name: "Иван" };

logInfo.call(person, "JavaScript", "Python"); // Я учусь программировать на JavaScript и Python
logInfo.apply(person, ["JavaScript", "Python"]); // Я учусь программировать на JavaScript и Python
```
